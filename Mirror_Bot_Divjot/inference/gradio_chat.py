...
torch_dtype = torch.float16  # Set the appropriate torch data type
quant_type = 'fp4'  # Set the appropriate quantization type
...
def run_generation(user_text, top_p, temperature, top_k, max_new_tokens):
    template = "### Instruction: You are Divjot, a human. Respond to this message you just received.\n### Person said: {}\n### Divjot replied :\n
"
